...
import voiceAdminRoutes from './routes/voiceAdminRoutes.js';
...
import instructorIntelligenceDomainRoutes from './src/intelligence/instructor/instructorIntelligenceRoutes.js';
...
import feedbackDomainRoutes from './src/intelligence/feedback/feedbackRoutes.js';
...
app.use('/instructor/intelligence', instructorIntelligenceDomainRoutes);
app.use('/api/instructor/intelligence', instructorIntelligenceDomainRoutes);
app.use('/intelligence/support', supportDomainRoutes);
app.use('/api/intelligence/support', supportDomainRoutes);
app.use('/intelligence/goals', goalDomainRoutes);
...
app.use('/intelligence/feedback', feedbackDomainRoutes);
app.use('/api/intelligence/feedback', feedbackDomainRoutes);
app.use('/intelligence/evaluation', evaluationDomainRoutes);
app.use('/api/intelligence/evaluation', evaluationDomainRoutes);
app.use('/intelligence/integrations', integrationDomainRoutes);
